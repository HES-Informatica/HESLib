...
namespace HES
{
    public class DANFE : IDisposable
    {
        ...
        public DANFE(DANFEModel viewModel)
        {
            ...
            // Bloco de Condição de Uso (Carta de Correção)
            if (!string.IsNullOrWhiteSpace(ViewModel.TextoCondicaoDeUso))
                AdicionarBloco<BlocoCondicaoCCE>();
        ...
        private void AdicionarMetadata()
        {
            ...
            info.Creator = string.Format("{0} {1} - {2}", "HESLib", System.Reflection.Assembly.GetExecutingAssembly().GetName().Version, "https://hes.com.br");
        ...
        private DanfePagina CriarPagina()
        {
            ...
            if (ViewModel.TipoAmbiente == TAmb.Homologacao)
